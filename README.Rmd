...
The goal of domar is to get administrative registries data from corresponding source and restructered it in tabular form. Besides `domar` give functions for storage this data in Google Sheets.
