...
Once you have followed the above instructions and installed the package. Run `browse.vignettes('domar')` in the R console to get more detailed instructions on the use of the package.
