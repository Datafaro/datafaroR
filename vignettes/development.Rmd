...
Install the API to have acces to domar_list
...
If `downloader` don't meet you needs you can proposed a modified versión of `downloader`, granting this continue working for others indicators.
...
If your are working in an indicator it's importan that you put you name in the `Working` field.
